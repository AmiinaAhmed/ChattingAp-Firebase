...
public class StatusUpdateActivity extends AppCompatActivity {
    ...
    private void changeProfileStatus(String new_status) {
        if (TextUtils.isEmpty(new_status)){
            ...
            Toast.makeText(getApplicationContext(), "Please write something about status",Toast.LENGTH_LONG).show();
        } else {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(getApplicationContext(), "Error occurred: failed to update.",Toast.LENGTH_LONG).show();
                            }
                        }
                    });
        }
