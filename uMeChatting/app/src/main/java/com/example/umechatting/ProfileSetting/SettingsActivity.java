package com.example.umechatting.ProfileSetting;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editStatusBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent statusUpdateIntent = new Intent(SettingsActivity.this, com.example.umechatting.ProfileSetting.StatusUpdateActivity.class);
    ...
    private void saveInformation(String uName, String uNickname, String uPhone, String uProfession, String uGender) {
        if (uGender.length()<1){
            ...
            Toast.makeText(this, "Oops! your name can't be empty",Toast.LENGTH_LONG).show();
        } else if (uName.length()<3 || uName.length()>40){
            Toast.makeText(this, "Your name should be 3 to 40 numbers of characters",Toast.LENGTH_LONG).show();
        } else if (TextUtils.isEmpty(uPhone)){
            Toast.makeText(this, "Your mobile number is required.",Toast.LENGTH_LONG).show();
        } else if (uPhone.length()<11){

            Toast.makeText(this, "Sorry! your mobile number is too short",Toast.LENGTH_LONG).show();
        } else {
