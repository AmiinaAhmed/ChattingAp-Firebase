...
import com.example.umechatting.Model.Requests;
 ...
 */
public class RequestsFragment extends androidx.fragment.app.Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Requests, RequestsVH> adapter = new FirebaseRecyclerAdapter<Requests, RequestsVH>(recyclerOptions) {
            @Override
            protected void onBindViewHolder( final RequestsVH holder, int position,  Requests model) {
            ...
            @Override
            public RequestsVH onCreateViewHolder( ViewGroup viewGroup, int viewType) {
