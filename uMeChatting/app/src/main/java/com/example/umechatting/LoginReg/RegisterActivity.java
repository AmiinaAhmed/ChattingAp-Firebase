...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void registerAccount(final String name, final String email, final String mobile, String password, String confirmPassword) {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            Toast.makeText(myContext, "Your name is required.",Toast.LENGTH_LONG).show();
        } else if (name.length() < 3 || name.length() > 40){

            Toast.makeText(myContext, "Your name should be 3 to 40 numbers of characters.",Toast.LENGTH_LONG).show();

        } else if (TextUtils.isEmpty(email)){

            Toast.makeText(myContext, "Your email is required.",Toast.LENGTH_LONG).show();
        } else if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()){

            Toast.makeText(myContext, "Your email is not valid.",Toast.LENGTH_LONG).show();

        } else if (TextUtils.isEmpty(mobile)){

            Toast.makeText(myContext, "Your mobile number is required.",Toast.LENGTH_LONG).show();
        } else if (mobile.length() < 11){

            Toast.makeText(myContext, "Mobile number should be min 11 characters.",Toast.LENGTH_LONG).show();

        } else if (TextUtils.isEmpty(password)){

            Toast.makeText(myContext, "Please fill this password field",Toast.LENGTH_LONG).show();
        } else if (password.length() < 6){

            Toast.makeText(myContext, "Create a password at least 6 characters long.",Toast.LENGTH_LONG).show();
        }else if (TextUtils.isEmpty(confirmPassword)){

            Toast.makeText(myContext, "Please retype in password field",Toast.LENGTH_LONG).show();
        } else if (!password.equals(confirmPassword)){

            Toast.makeText(myContext, "Your password don't match with your confirm password",Toast.LENGTH_LONG).show();
                                                                                ...
                                                                                public void run() {
                                                                                    RegisterActivity.this.runOnUiThread(new Runnable() {
                                                                                        public void run() {
                                                                                            ...
                                                                                            Toast.makeText(myContext, "Please check your email & verify.",Toast.LENGTH_LONG).show();
