package com.example.umechatting.Friends;
...
import com.example.umechatting.Chat.ChatActivity;
import com.example.umechatting.Model.Friends;
...
public class FriendsActivity extends AppCompatActivity {
    ...
    private void showPeopleList(){
        ...
        FirebaseRecyclerAdapter<Friends, FriendsVH> recyclerAdapter = new FirebaseRecyclerAdapter<Friends, FriendsVH>(recyclerOptions) {
            @Override
            protected void onBindViewHolder( final FriendsVH holder, int position,  Friends model) {
            ...
            @Override
            public FriendsVH onCreateViewHolder( ViewGroup viewGroup, int viewType) {
