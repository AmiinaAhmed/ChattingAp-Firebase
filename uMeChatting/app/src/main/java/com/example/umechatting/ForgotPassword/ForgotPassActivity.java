package com.example.umechatting.ForgotPassword;
        ...
        resetPassButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(email)){
                    ...
                    Toast.makeText(ForgotPassActivity.this, "Email is required",Toast.LENGTH_LONG).show();
                } else if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()){

                    Toast.makeText(ForgotPassActivity.this,"Email format is not valid.",Toast.LENGTH_LONG).show();
                } else {
